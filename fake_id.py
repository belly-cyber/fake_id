...
if "fake_id.db" in os.listdir("dbs/"):
    dic={}
    database=sqlite3.connect("dbs/fake_id.db")
    ...
    raw_domains=requests.get('https://github.com/mailcheck/mailcheck/wiki/List-of-Popular-Domains')
